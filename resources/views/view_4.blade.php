    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 18px; color: #333; text-align: center; margin: 20px 0;">
                Chào <strong>{{ $data['ho_va_ten'] }}</strong>,<br>
            ...
            <div class="movie-info">
                ...
                <div class="movie-details">
                    ...
                    <strong>Rạp:</strong> {{ $data['ten_phong_chieu'] }}<br>
                    <strong>Địa chỉ:</strong> {{ $data['dia_chi'] }}
                </div>
            </div>
                ...
                <tbody>
                    @foreach ($data['ds_ve'] as $index => $value)
                        <tr>
                            ...
                            <td class="price">{{number_format($value->gia_ve, 0)}}</td>
                        </tr>
                    @endforeach
            ...
            <table class="details-table">
                ...
                <tbody>
                    @foreach ($data['ds_dv'] as $index => $value)
                        <tr>
                            <td><strong>{{$value->ten_dich_vu}}</strong></td>
                            <td>{{$value->mo_ta}}</td>
                            <td class="price">{{number_format($value->gia_ve, 0)}}</td>
                        </tr>
                    @endforeach
            ...
            <div class="discount-section">
                <h3 style="margin-top: 0; color: #d35400;">💰 Mã giảm giá áp dụng</h3>
                <p>Mã: <span class="discount-code">{{ $data['ma_giam_gia'] }}</span></p>
                <p>Giảm giá: <strong style="color: #d35400;">-{{number_format($data['tien_giam_gia'], 0)}}đ</strong></p>
            </div>

            <!-- Payment Information -->
            <div class="payment-info">
                <h3 style="margin-top: 0; color: #27ae60;">💳 Thông tin thanh toán</h3>
                <div class="payment-method">Phương thức: {{ $data['pay_method'] }}</div>
            ...
            <div class="total-section">
                ...
                <div class="total-amount">{{number_format($data['so_tien'], 0)}}đ</div>
                <p style="margin-bottom: 0;">Đã bao gồm VAT</p>
            </div>
            ...
            <div class="qr-section">
                ...
                <div class="qr-code">
                    <div style="text-align: center;">
                        <img style="width: 200px" src="{{ $data['link_qr_code'] }}" alt="">
                    </div>
                </div>
            </div>
            ...
            <!-- Customer Support -->
            <div
                style="background-color: #f0f8ff; border: 1px solid #4a90e2; border-radius: 8px; padding: 20px; margin: 20px 0;">
                <h3 style="color: #4a90e2; margin-top: 0;">📞 Hỗ trợ khách hàng</h3>
                <p><strong>Hotline:</strong> <span class="highlight">1900 1234</span></p>
                <p><strong>Email:</strong> <span class="highlight">support@dzcinema.com</span></p>
                <p><strong>Giờ làm việc:</strong> 8:00 - 22:00 (tất cả các ngày trong tuần)</p>
                <p style="margin-bottom: 0;">Chúng tôi luôn sẵn sàng hỗ trợ bạn!</p>
            </div>

            <p style="text-align: center; font-size: 18px; color: #27ae60; font-weight: bold; margin: 30px 0;">
        ...
        <div class="footer">
            <div class="footer-content">
                ...
                <div class="footer-links">
                    <a href="webDZ">Website</a>
                    <a href="fbDZ">Facebook</a>
                    <a href="mbDZ">Ứng dụng di động</a>
                    <a href="ZaloDZ">Liên hệ</a>
                </div>

                <p style="font-size: 14px;">
                    📍 Địa chỉ: {{ $data['dia_chi'] }}<br>
